...
sub read {
    my ($self, $name) = @_;
    return read_file(File::Spec->catfile(Module::Info->new_from_loaded(__PACKAGE__)->inc_dir, split('::', __PACKAGE__), 'inc', "$name$SUFFIX"), err_mode => 'carp');
}
...
1; # End of MarpaX::Languages::C::AST::Data::AnsiC2011
