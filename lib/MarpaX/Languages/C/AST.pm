...
This modules translates a C source into an AST tree. The AST consist of blessed objects that map exactly to the C grammar in use.
...
x1 x;
C_SOURCE_CODE
    my $cAst = $cAstObject->process({source => \$input});
    print Dumper($cAst);
